...
<body id="root">
    <nav class="bg-white shadow-lg mb-5 fixed top-0 w-full">
            ...
            <div class="flex justify-between">
                <div class="flex space-x-7">
                    ...
                    <div class="hidden md:flex items-center space-x-1">
                        <a href="" class="py-4 px-6 text-green-500 border-b-4 border-green-500 suprema-regular capitalize">Mis parcelas</a>
                        ...
                        <a href="" class="py-4 px-6 text-gray-500 suprema-regular hover:text-green-500 transition duration-300 capitalize">Agregar nueva parcela</a>
                    </div>
                </div>
        ...
        <div class="hidden mobile-menu">
            <ul class="">
                <li class="active"><a href="#" class="block text-sm px-2 py-4 text-white bg-green-500 suprema-regular capitalize">Mis parcelas</a></li>
                ...
                <li><a href="#" class="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300 suprema-regular capitalize">Agregar nueva parcela</a></li>
